...
public class SoapHelper {
  ...
  public Set<Project> getProjects() throws MalformedURLException, ServiceException, RemoteException {
    ...
    ProjectData[] projects = mc.mc_projects_get_user_accessible(
            app.getProperty("soap.adminLogin"), app.getProperty("soap.adminPassword"));
  ...
  public MantisConnectPortType getMantisConnect() throws ServiceException, MalformedURLException {
    return new MantisConnectLocator()
              .getMantisConnectPort(new URL(app.getProperty("soap.endpoint")));
  }
  ...
  public Issue addIssue(Issue issue) throws MalformedURLException, ServiceException, RemoteException {
    ...
    BigInteger issueId = mc.mc_issue_add(
            app.getProperty("soap.adminLogin"), app.getProperty("soap.adminPassword"), issueData);
    IssueData createdIssueData = mc.mc_issue_get(
            app.getProperty("soap.adminLogin"), app.getProperty("soap.adminPassword"), issueId);
